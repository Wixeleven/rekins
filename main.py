...
def lietotaja_ievade():
    print("\033[036m{}\033[0m".format("A bill is proposed legislation under consideration by a legislature.\n "
                                     "A bill does not become law until it is passed by the legislature and, in most cases, approved by the executive."))
    name = input('What is your name: ')
    tekst = input('Write your tekst:')
    ...
    cam = [format(produkta_cena),format(PVN_summa),format(rekina_summa)]
